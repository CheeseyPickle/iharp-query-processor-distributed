...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RASTERRESPONSE']._serialized_end=358
  _globals['_DBNODE']._serialized_start=360
  _globals['_DBNODE']._serialized_end=418
